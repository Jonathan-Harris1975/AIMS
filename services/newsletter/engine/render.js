...
<section class="card"><p class="tag">Your Turn</p><h2>${escapeHtml(newsletter.yourTurn || "")}</h2></section></div></main>${siteShell.footerHtml}${siteShell.manifest.scriptGovernanceUrl ? `<script defer data-cookieyes="ignore" data-cookieconsent="ignore" src="${escapeHtml(siteShell.manifest.scriptGovernanceUrl)}"></script>` : ""}<script defer src="${escapeHtml(siteShell.manifest.siteUiScriptUrl)}"></script></body></html>`;
}
