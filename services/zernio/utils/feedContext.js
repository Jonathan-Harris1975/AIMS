...
import { ZERNIO_RSS_LOOKBACK_DAYS } from "./config.js";
...
export async function loadRecentRssContext({ days = ZERNIO_RSS_LOOKBACK_DAYS, maxItems = 8 } = {}) {
  try {
    ...
    const cutoff = Date.now() - Number(days || ZERNIO_RSS_LOOKBACK_DAYS) * 86400000;
