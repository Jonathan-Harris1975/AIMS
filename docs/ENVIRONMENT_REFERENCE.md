...
| `ARTWORK_VISUAL_QA_ENABLED` | Yes | services/artwork/utils/artwork.js:204 |
| `ARTWORK_VISUAL_QA_MAX_REGENERATIONS` | Yes | services/artwork/utils/artwork.js:336 |
...
| `ARTWORK_VISUAL_QA_MODES` | Yes | services/artwork/utils/artwork.js:197 |
...
| `BLOG_PREFIX` | Yes | services/blog/routes/rss.js:9<br>services/blog/weekly/buildWeeklyBlogPost.js:485 |
...
| `BLOG_RSS_OBJECT_KEY` | Yes | services/blog/rss/publishBlogRssFeed.js:130<br>services/blog/weekly/buildWeeklyBlogPost.js:620<br>services/blog/weekly/buildWeeklyBlogPost.js:737 |
...
| `BLOG_SOCIAL_BUILD_COMPLETED_TTL_MS` | No | services/blog/social/buildDailySocialBlogPost.js:57 |
| `BLOG_SOCIAL_BUILD_PENDING_TTL_MS` | No | services/blog/social/buildDailySocialBlogPost.js:56 |
| `BLOG_SOCIAL_FALLBACK_IMAGE_URL` | Yes | services/blog/social/buildDailySocialBlogPost.js:363 |
| `BLOG_SOCIAL_PREFIX` | Yes | services/blog/routes/social.js:41<br>services/blog/social/buildDailySocialBlogPost.js:665<br>services/blog/social/publishSocialBlogRssFeed.js:69 |
| `BLOG_SOCIAL_PUBLIC_BASE_URL` | Yes | services/blog/social/buildDailySocialBlogPost.js:210<br>services/blog/social/publishSocialBlogRssFeed.js:74 |
| `BLOG_SOCIAL_PUBLIC_POSTS_BASE_URL` | Yes | services/blog/social/buildDailySocialBlogPost.js:214<br>services/blog/social/publishSocialBlogRssFeed.js:83 |
| `BLOG_SOCIAL_QA_ENABLED` | Yes | services/blog/social/buildDailySocialBlogPost.js:347 |
| `BLOG_SOCIAL_RSS_DESCRIPTION` | Yes | services/blog/social/publishSocialBlogRssFeed.js:358 |
| `BLOG_SOCIAL_RSS_OBJECT_KEY` | Yes | services/blog/social/buildDailySocialBlogPost.js:902<br>services/blog/social/buildDailySocialBlogPost.js:1032<br>services/blog/social/buildDailySocialBlogPost.js:1212<br>services/blog/social/publishSocialBlogRssFeed.js:91 |
...
| `BLOTATO_DEFAULT_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1399 |
| `BLOTATO_DEFAULT_FOLLOW_CTA` | Yes | services/blotato/utils/newsShortsService.js:230 |
| `BLOTATO_FACEBOOK_MEDIA_TYPE` | Yes | services/blotato/utils/autoPublishService.js:1023 |
| `BLOTATO_FACEBOOK_PAGE_ID` | Yes | services/blotato/utils/autoPublishService.js:878<br>services/blotato/utils/autoPublishService.js:1020 |
| `BLOTATO_FACEBOOK_SUBACCOUNT_ID` | No | services/blotato/utils/autoPublishService.js:878<br>services/blotato/utils/autoPublishService.js:1020 |
...
| `BLOTATO_INLINE_PUBLISH_JOBS` | No | services/blotato/utils/autoPublishService.js:2652 |
| `BLOTATO_INSTAGRAM_SHARE_TO_FEED` | Yes | services/blotato/utils/autoPublishService.js:990 |
| `BLOTATO_KEEPALIVE_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1696 |
...
| `BLOTATO_NEWS_AUDIENCE` | No | services/blotato/utils/autoPublishService.js:1740 |
| `BLOTATO_NEWS_CTA` | Yes | services/blotato/utils/autoPublishService.js:1745 |
| `BLOTATO_NEWS_DURATION_SECONDS` | Yes | services/blotato/utils/autoPublishService.js:1738 |
...
| `BLOTATO_NEWS_RESPONSE_FORMAT_MODE` | Yes | services/blotato/utils/newsShortsService.js:1291 |
...
| `BLOTATO_NEWS_TEMPLATE_ID` | Yes | services/blotato/utils/autoPublishService.js:1412<br>services/blotato/utils/autoPublishService.js:1413 |
| `BLOTATO_NEWS_TEMPLATE_SEARCH` | Yes | services/blotato/utils/autoPublishService.js:348<br>services/blotato/utils/autoPublishService.js:1417 |
| `BLOTATO_NEWS_THEME` | No | services/blotato/utils/autoPublishService.js:1736 |
...
| `BLOTATO_PUBLISH_SEQUENTIAL` | Yes | services/blotato/utils/autoPublishService.js:1359 |
| `BLOTATO_PUBLISH_STAGGER_MS` | Yes | services/blotato/utils/autoPublishService.js:1358 |
...
| `BLOTATO_RENDERED_QA_BLOCK_HARD_FAILURES` | Yes | services/blotato/utils/autoPublishService.js:2068 |
| `BLOTATO_RENDERED_QA_BLOCK_SOFT_FAILURES` | Yes | services/blotato/utils/autoPublishService.js:2065 |
...
| `BLOTATO_REQUIRE_ALL_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:2235 |
| `BLOTATO_REQUIRE_SCHEDULE_CONFIRMATION` | Yes | services/blotato/utils/autoPublishService.js:1215 |
...
| `BLOTATO_RSS_PICK_MODE` | Yes | services/blotato/utils/autoPublishService.js:1418<br>services/blotato/utils/rssArticlePicker.js:67<br>services/blotato/utils/rssArticleSource.js:220 |
...
| `BLOTATO_SCHEDULE_RECOVERY_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1660 |
...
| `BLOTATO_TEMPLATE_AUTO_DISCOVERY` | Yes | services/blotato/utils/autoPublishService.js:346<br>services/blotato/utils/autoPublishService.js:1416 |
| `BLOTATO_TEMPLATE_ID_MODE` | Yes | services/blotato/utils/autoPublishService.js:167<br>services/blotato/utils/autoPublishService.js:1414 |
| `BLOTATO_TEMPLATE_SEARCH` | No | services/blotato/utils/autoPublishService.js:348<br>services/blotato/utils/autoPublishService.js:1417 |
| `BLOTATO_TEMPLATE_VERIFY` | Yes | services/blotato/utils/autoPublishService.js:344<br>services/blotato/utils/autoPublishService.js:1415 |
| `BLOTATO_TEXT_TO_IMAGE_MODEL` | Yes | services/blotato/utils/autoPublishService.js:471<br>services/blotato/utils/newsShortsService.js:46 |
| `BLOTATO_THUMBNAIL_TEXT_WORDS` | Yes | services/blotato/utils/newsShortsService.js:56 |
| `BLOTATO_THURSDAY_PODCAST_PLUG` | Yes | services/blotato/utils/newsShortsService.js:226 |
| `BLOTATO_TIKTOK_DISABLED_COMMENTS` | Yes | services/blotato/utils/autoPublishService.js:1010 |
| `BLOTATO_TIKTOK_DISABLED_DUET` | Yes | services/blotato/utils/autoPublishService.js:1011 |
| `BLOTATO_TIKTOK_DISABLED_STITCH` | Yes | services/blotato/utils/autoPublishService.js:1012 |
| `BLOTATO_TIKTOK_IS_AI_GENERATED` | Yes | services/blotato/utils/autoPublishService.js:1015 |
| `BLOTATO_TIKTOK_IS_BRANDED_CONTENT` | Yes | services/blotato/utils/autoPublishService.js:1013 |
| `BLOTATO_TIKTOK_IS_YOUR_BRAND` | Yes | services/blotato/utils/autoPublishService.js:1014 |
| `BLOTATO_TIKTOK_PRIVACY_LEVEL` | Yes | services/blotato/utils/autoPublishService.js:1009 |
| `BLOTATO_TIMEOUT_MS` | Yes | services/blotato/utils/blotatoClient.js:151 |
| `BLOTATO_USE_BRAND_KIT` | Yes | services/blotato/utils/autoPublishService.js:586 |
| `BLOTATO_USE_MANUAL_TEMPLATE_INPUTS` | Yes | services/blotato/utils/autoPublishService.js:579 |
...
| `BLOTATO_YOUTUBE_NOTIFY_SUBSCRIBERS` | Yes | services/blotato/utils/autoPublishService.js:999 |
| `BLOTATO_YOUTUBE_PRIVACY_STATUS` | Yes | services/blotato/utils/autoPublishService.js:998 |
...
| `COMMS_HUB_APPROVALS_ENFORCED` | Yes | services/comms-hub/routes/index.js:123 |
| `COMMS_HUB_ATTACHMENT_SCANNER_TOKEN` | Yes | services/comms-hub/routes/index.js:128 |
| `COMMS_HUB_ATTACHMENT_SCANNER_URL` | Yes | services/comms-hub/routes/index.js:127 |
| `COMMS_HUB_AUTONOMOUS_REPLIES_ENABLED` | Yes | services/comms-hub/routes/index.js:142 |
| `COMMS_HUB_BACKUP_ENABLED` | Yes | services/comms-hub/routes/index.js:124 |
| `COMMS_HUB_CONTENT_AUTOMATION_BLOG_ENABLED` | Yes | services/comms-hub/routes/index.js:137 |
| `COMMS_HUB_CONTENT_AUTOMATION_BLOTATO_VIDEO_BRIEF_LIMIT` | Yes | services/blotato/utils/autoPublishService.js:2543 |
| `COMMS_HUB_CONTENT_AUTOMATION_BRIEF_LEASE_MS` | Yes | services/comms-hub/contentAutomationQueueCore.js:325 |
| `COMMS_HUB_CONTENT_AUTOMATION_BRIEF_LIMIT` | Yes | services/blog/social/buildDailySocialBlogPost.js:679<br>services/blog/weekly/buildWeeklyBlogPost.js:499<br>services/podcast/runPodcastPipeline.js:140 |
...
| `COMMS_HUB_CONTENT_AUTOMATION_ENABLED` | Yes | services/comms-hub/routes/index.js:135 |
| `COMMS_HUB_CONTENT_AUTOMATION_PODCAST_ENABLED` | Yes | services/comms-hub/routes/index.js:139 |
| `COMMS_HUB_CONTENT_AUTOMATION_SOCIAL_ENABLED` | Yes | services/comms-hub/routes/index.js:138 |
| `COMMS_HUB_CONTENT_AUTOMATION_ZERNIO_MINI_SERIES_BRIEF_LIMIT` | Yes | services/zernio/utils/socialScheduler.js:2267 |
| `COMMS_HUB_CREDENTIAL_VAULT_ENABLED` | Yes | services/comms-hub/routes/index.js:146 |
| `COMMS_HUB_DELAYED_ACTION_WORKER_ENABLED` | Yes | services/comms-hub/routes/index.js:143 |
| `COMMS_HUB_EMAIL_ENABLED` | Yes | services/comms-hub/routes/index.js:130 |
| `COMMS_HUB_ENABLED` | Yes | scripts/performanceGate.js:7 |
| `COMMS_HUB_FORM_AUTO_SEND_ENABLED` | Yes | services/comms-hub/routes/index.js:141 |
| `COMMS_HUB_FORM_ORCHESTRATION_ENABLED` | Yes | services/comms-hub/routes/index.js:133 |
| `COMMS_HUB_FORM_SMART_PROCESSING_ENABLED` | Yes | services/comms-hub/routes/index.js:134 |
| `COMMS_HUB_MAX_WEBHOOK_BYTES` | Yes | server.js:257<br>server.js:347 |
| `COMMS_HUB_MONTH_END_ARCHIVE_ENABLED` | Yes | services/comms-hub/routes/index.js:145 |
...
| `COMMS_HUB_RETENTION_WORKER_ENABLED` | Yes | services/comms-hub/routes/index.js:144 |
| `COMMS_HUB_SMART_RESPONSE_ENABLED` | Yes | services/comms-hub/routes/index.js:132 |
...
| `DIGITAL_GROWTH_AI_REPAIR_MAX_TOKENS` | Yes | audits/utils/digitalGrowthAnalysis.js:492 |
| `DIGITAL_GROWTH_AI_REPAIR_TIMEOUT_MS` | Yes | audits/utils/digitalGrowthAnalysis.js:494 |
| `DIGITAL_GROWTH_AI_TEMPERATURE` | No | audits/utils/digitalGrowthAnalysis.js:465 |
| `DIGITAL_GROWTH_AI_TIMEOUT_MS` | Yes | audits/utils/digitalGrowthAnalysis.js:466 |
| `DIGITAL_GROWTH_RAW_RESPONSE_MAX_CHARS` | Yes | audits/utils/digitalGrowthAnalysis.js:416 |
...
| `OUTREACH_BATCH_SIZE` | Yes | services/outreach/services/batchService.js:147<br>services/outreach/utils/r2ProgressStore.js:7 |
...
| `PHASE3_AUTOPUBLISH_MIN_SCORE` | Yes | services/content-quality/phase3Gates.js:340 |
| `PHASE3_MAX_PODCAST_SENTENCE_WORDS` | Yes | services/content-quality/phase3Gates.js:344 |
| `PHASE3_MAX_SENTENCE_WORDS` | Yes | services/content-quality/phase3Gates.js:345 |
| `PHASE3_RSS_SOURCE_COVERAGE_MIN` | No | services/content-quality/phase3Gates.js:371 |
| `PHASE3_RSS_SOURCE_OVERLAP_MIN` | No | services/content-quality/phase3Gates.js:368 |
| `PHASE3_SOURCE_COVERAGE_MIN` | No | services/content-quality/phase3Gates.js:372 |
| `PHASE3_SOURCE_MIN_CHARS` | Yes | services/content-quality/phase3Gates.js:341 |
| `PHASE3_SOURCE_OVERLAP_MIN` | No | services/content-quality/phase3Gates.js:369 |
| `PLAYWRIGHT_CHROMIUM_EXECUTABLE_PATH` | Yes | audits/utils/contentMasterCouncil.js:188<br>audits/utils/websiteAuditCouncil.js:1081<br>services/artwork/utils/quizCardRenderer.js:21 |
...
| `R2_BUCKET_COMMS_HUB_PRIVATE` | Yes | services/comms-hub/routes/index.js:126 |
...
| `RAMS_API_KEY` | Yes | audits/utils/ramsContentDispatch.js:5<br>audits/utils/ramsWebsiteDispatch.js:24 |
| `RAMS_BASE_URL` | Yes | audits/utils/ramsContentDispatch.js:4<br>audits/utils/ramsWebsiteDispatch.js:23 |
...
| `RAMS_DISPATCH_MAX_ATTEMPTS` | Yes | audits/utils/ramsContentDispatch.js:6<br>audits/utils/ramsWebsiteDispatch.js:30 |
...
| `REVIEW_COUNCIL_STAGNATION_LIMIT` | Yes | services/content-quality/reviewCouncil.js:613 |
| `RMS_API_KEY` | Yes | audits/utils/ramsContentDispatch.js:5<br>audits/utils/ramsWebsiteDispatch.js:24 |
| `RMS_BASE_URL` | No | audits/utils/ramsContentDispatch.js:5<br>audits/utils/ramsWebsiteDispatch.js:23 |
...
| `SOCIAL_ARTWORK_VISUAL_QA_ADVISORY_MIN_RELEVANCE` | Yes | services/artwork/utils/artwork.js:238 |
| `SOCIAL_ARTWORK_VISUAL_QA_ADVISORY_MIN_SCORE` | Yes | services/artwork/utils/artwork.js:237 |
| `SOCIAL_ARTWORK_VISUAL_QA_ADVISORY_MIN_TEXT_SAFETY` | Yes | services/artwork/utils/artwork.js:239 |
| `SOCIAL_ARTWORK_VISUAL_QA_ALLOW_SOFT_FAILURES` | Yes | services/artwork/utils/artwork.js:261 |
...
| `WEBSITE_REBUILD_HOOK` | Yes | scripts/backfill-blog-main-site-links.js:20<br>services/blog/social/buildDailySocialBlogPost.js:237<br>services/blog/weekly/buildWeeklyBlogPost.js:219<br>services/podcast/runPodcastPipeline.js:73 |
| `WEBSITE_REBUILD_HOOK_FALLBACK` | Yes | scripts/backfill-blog-main-site-links.js:21<br>services/blog/social/buildDailySocialBlogPost.js:238<br>services/blog/weekly/buildWeeklyBlogPost.js:220<br>services/podcast/runPodcastPipeline.js:74 |
| `X` | No | config/thresholds.js:6<br>config/thresholds.js:16 |
| `ZERNIO_ACCOUNT_ID` | Yes | services/zernio/utils/config.js:64 |
| `ZERNIO_ALLOW_CURATED_ARTWORK_FALLBACK` | Yes | services/zernio/utils/socialScheduler.js:1764<br>services/zernio/utils/socialScheduler.js:2664<br>services/zernio/utils/socialScheduler.js:3123<br>services/zernio/utils/socialScheduler.js:3532 |
...
| `ZERNIO_BLOG_RSS_IMAGE_URL` | Yes | services/zernio/utils/config.js:107 |
| `ZERNIO_BLOG_RSS_TIME` | Yes | services/zernio/utils/config.js:104 |
...
| `ZERNIO_FRIDAY_BUILD_CONTEXT` | No | services/zernio/utils/socialScheduler.js:81 |
| `ZERNIO_FRIDAY_BUILD_CONTEXT_TTL_DAYS` | No | services/zernio/utils/socialScheduler.js:104 |
...
| `ZERNIO_MINI_SERIES_IMAGE_URL` | Yes | services/zernio/utils/config.js:200 |
...
| `ZERNIO_MINI_SERIES_RETRY_BASE_MS` | Yes | services/zernio/utils/socialScheduler.js:2722 |
...
| `ZERNIO_PODCAST_PROMO_IMAGE_URL` | Yes | services/zernio/utils/config.js:217 |
| `ZERNIO_PODCAST_PROMO_MAX_TOKENS` | Yes | services/zernio/utils/socialScheduler.js:48 |
...
| `ZERNIO_POST_MAX_CHARACTERS` | Yes | services/zernio/utils/config.js:85 |
| `ZERNIO_PROFILE_NAME_EBOOKS` | Yes | services/zernio/utils/config.js:61 |
| `ZERNIO_PROFILE_NAME_GENERAL` | Yes | services/zernio/utils/config.js:60 |
| `ZERNIO_QUIZ_ANSWER_IMAGE_URL` | Yes | services/zernio/utils/config.js:183 |
...
| `ZERNIO_QUIZ_IMAGE_URL` | Yes | services/zernio/utils/config.js:182 |
| `ZERNIO_QUIZ_MAX_TOKENS` | No | services/zernio/utils/socialScheduler.js:44 |
...
| `ZERNIO_TIMEZONE` | Yes | services/zernio/utils/config.js:54 |
...
| `ZERNIO_VALIDATE_TARGET_ACCOUNTS` | Yes | services/zernio/utils/config.js:74 |
