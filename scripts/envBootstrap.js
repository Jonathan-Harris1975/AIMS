...
export const ENV = {
  ...
  HEADROOM_MIN_INPUT_CHARS: num("HEADROOM_MIN_INPUT_CHARS", 2000),
  HEADROOM_TARGET_RATIO: num("HEADROOM_TARGET_RATIO", 0.7),
  ...
  OPENROUTER_GPT_5_6_LUNA: opt("OPENROUTER_GPT_5_6_LUNA"),
  OPENROUTER_API_KEY_GPT_5_6_LUNA: opt("OPENROUTER_API_KEY_GPT_5_6_LUNA"),
  ...
  BLOTATO_SCRIPT_MODEL: opt("BLOTATO_SCRIPT_MODEL", "openai/gpt-5.6-luna"),
