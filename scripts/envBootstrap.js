...
export const KOYEB_ENV_KEYS = [
  ...
  "ONEUP_API_KEY",
  "OUTREACH_BATCH_SIZE",
  "OUTREACH_MIN_EMAIL_SCORE",
  "OUTREACH_MIN_LEAD_SCORE",
...
for (const key of KOYEB_ENV_KEYS) {
