...
export function buildInstruction(prompt, mode = "podcast", date) {
  ...
  if (mode === "blog") {
    return [
      ...
      "Style: premium magazine-feature art direction with cinematic lighting, bold controlled colour, strong contrast, a clear focal story and thumbnail-scale impact rather than corporate abstraction.",
  ...
  return [
    ...
    "Style: premium magazine-cover storytelling with a strong focal subject, cinematic light, bold controlled colour, high contrast and clean negative space. Do not default to abstract technological geometry.",
    `Creative direction: ${policyPrompt}`,
