...
export const ENV = {
  ...
  AI_STICKY_PROVIDER_ROUTING: bool("AI_STICKY_PROVIDER_ROUTING", false),
  AI_MODEL_BLOCKLIST: str("AI_MODEL_BLOCKLIST", "deepseek/*"),
  PODCAST_SYNTHESIS_MAX_TOKENS: num("PODCAST_SYNTHESIS_MAX_TOKENS", 24000),
  PODCAST_SYNTHESIS_TIMEOUT_MS: num("PODCAST_SYNTHESIS_TIMEOUT_MS", 900000),
  PODCAST_EDITORIAL_MAX_TOKENS: num("PODCAST_EDITORIAL_MAX_TOKENS", 32000),
  PODCAST_EDITORIAL_TIMEOUT_MS: num("PODCAST_EDITORIAL_TIMEOUT_MS", 900000),
  PODCAST_REPAIR_MAX_TOKENS: num("PODCAST_REPAIR_MAX_TOKENS", 16000),
  PODCAST_REPAIR_TIMEOUT_MS: num("PODCAST_REPAIR_TIMEOUT_MS", 900000),
  PODCAST_SYNTHESIS_REASONING_EFFORT: str("PODCAST_SYNTHESIS_REASONING_EFFORT", "low"),
  PODCAST_EDITORIAL_REASONING_EFFORT: str("PODCAST_EDITORIAL_REASONING_EFFORT", "none"),
  PODCAST_REPAIR_REASONING_EFFORT: str("PODCAST_REPAIR_REASONING_EFFORT", "none"),
  ...
  HEADROOM_ENABLED: bool("HEADROOM_ENABLED", false),
  HEADROOM_REQUIRED: bool("HEADROOM_REQUIRED", false),
  HEADROOM_BASE_URL: str("HEADROOM_BASE_URL"),
  HEADROOM_API_KEY: opt("HEADROOM_API_KEY"),
  HEADROOM_PROXY_TOKEN: opt("HEADROOM_PROXY_TOKEN"),
  HEADROOM_TIMEOUT_MS: num("HEADROOM_TIMEOUT_MS", 5000),
  HEADROOM_FAILURE_THRESHOLD: num("HEADROOM_FAILURE_THRESHOLD", 3),
  HEADROOM_CIRCUIT_OPEN_MS: num("HEADROOM_CIRCUIT_OPEN_MS", 30000),
  HEADROOM_MIN_INPUT_CHARS: num("HEADROOM_MIN_INPUT_CHARS", 1000),
  HEADROOM_TARGET_RATIO: num("HEADROOM_TARGET_RATIO", 0.30),
  HEADROOM_PROTECT_RECENT: num("HEADROOM_PROTECT_RECENT", 0),
  HEADROOM_COMPRESS_USER_MESSAGES: bool("HEADROOM_COMPRESS_USER_MESSAGES", true),
  HEADROOM_LOG_SAVINGS: bool("HEADROOM_LOG_SAVINGS", true),
  HEADROOM_ROUTES: str("HEADROOM_ROUTES"),
  ...
  OPENROUTER_CLAUDE_SONNET_5: opt("OPENROUTER_CLAUDE_SONNET_5"),
  OPENROUTER_CLAUDE_OPUS: opt("OPENROUTER_CLAUDE_OPUS"),
  OPENROUTER_CLAUDE_OPUS_4_7: opt("OPENROUTER_CLAUDE_OPUS_4_7"),
  OPENROUTER_GPT_5_6_SOL: opt("OPENROUTER_GPT_5_6_SOL"),
  ...
  ARTWORK_IMAGE_CONFIG_ENABLED: bool("ARTWORK_IMAGE_CONFIG_ENABLED", true),
  ARTWORK_IMAGE_RESOLUTION: str("ARTWORK_IMAGE_RESOLUTION", "2K"),
  ARTWORK_OUTPUT_FORMAT: str("ARTWORK_OUTPUT_FORMAT", "png"),
  PODCAST_ARTWORK_ASPECT_RATIO: str("PODCAST_ARTWORK_ASPECT_RATIO", "1:1"),
  BLOG_ARTWORK_ASPECT_RATIO: str("BLOG_ARTWORK_ASPECT_RATIO", "16:9"),
  NEWSLETTER_ARTWORK_ASPECT_RATIO: str("NEWSLETTER_ARTWORK_ASPECT_RATIO", "16:9"),
  SOCIAL_BLOG_ARTWORK_ASPECT_RATIO: str("SOCIAL_BLOG_ARTWORK_ASPECT_RATIO", "16:9"),
  SOCIAL_ARTWORK_ASPECT_RATIO: str("SOCIAL_ARTWORK_ASPECT_RATIO", "1:1"),
  QUIZ_ARTWORK_ASPECT_RATIO: str("QUIZ_ARTWORK_ASPECT_RATIO", "1:1"),
  ...
  PODCAST_TARGET_MINUTES: num("PODCAST_TARGET_MINUTES", 50),
  PODCAST_MAX_MINUTES: num("PODCAST_MAX_MINUTES", 70),
  ...
  BLOTATO_DEFAULT_CHANNELS: opt("BLOTATO_DEFAULT_CHANNELS", "instagram,youtube"),
  BLOTATO_INSTAGRAM_ACCOUNT_ID: opt("BLOTATO_INSTAGRAM_ACCOUNT_ID"),
  BLOTATO_YOUTUBE_ACCOUNT_ID: opt("BLOTATO_YOUTUBE_ACCOUNT_ID"),
  BLOTATO_VIDEO_POLL_ATTEMPTS: num("BLOTATO_VIDEO_POLL_ATTEMPTS", 720),
  BLOTATO_VIDEO_POLL_INTERVAL_MS: num("BLOTATO_VIDEO_POLL_INTERVAL_MS", 3000),
  BLOTATO_VIDEO_POLL_MAX_DURATION_MS: num("BLOTATO_VIDEO_POLL_MAX_DURATION_MS", 1800000),
  ...
  BLOTATO_API_RETRY_ATTEMPTS: num("BLOTATO_API_RETRY_ATTEMPTS", 6),
  BLOTATO_API_RETRY_MAX_MS: num("BLOTATO_API_RETRY_MAX_MS", 30000),
  BLOTATO_SCRIPT_MODEL: opt("BLOTATO_SCRIPT_MODEL", "anthropic/claude-sonnet-4.6"),
  BLOTATO_NEWS_RESPONSE_FORMAT_MODE: opt("BLOTATO_NEWS_RESPONSE_FORMAT_MODE", "json_object"),
  BLOTATO_STEP0_PREFLIGHT_ENABLED: bool("BLOTATO_STEP0_PREFLIGHT_ENABLED", true),
  BLOTATO_PREFLIGHT_REQUIRE_LISTED_ACCOUNTS: bool("BLOTATO_PREFLIGHT_REQUIRE_LISTED_ACCOUNTS", true),
  BLOTATO_PREFLIGHT_REQUIRE_LISTED_SUBACCOUNTS: bool("BLOTATO_PREFLIGHT_REQUIRE_LISTED_SUBACCOUNTS", true),
  BLOTATO_FACEBOOK_MEDIA_TYPE: opt("BLOTATO_FACEBOOK_MEDIA_TYPE", "reel"),
  BLOTATO_KEEPALIVE_ENABLED: bool("BLOTATO_KEEPALIVE_ENABLED", true),
  BLOTATO_KEEPALIVE_INTERVAL_MS: num("BLOTATO_KEEPALIVE_INTERVAL_MS", 20000),
  BLOTATO_PUBLISH_SEQUENTIAL: bool("BLOTATO_PUBLISH_SEQUENTIAL", true),
  BLOTATO_PUBLISH_STAGGER_MS: num("BLOTATO_PUBLISH_STAGGER_MS", 2500),
  BLOTATO_SCRIPT_TIMEOUT_MS: num("BLOTATO_SCRIPT_TIMEOUT_MS", 120000),
