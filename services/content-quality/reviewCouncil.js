...
export const REVIEW_COUNCILS = Object.freeze({
  ...
  "blog-phase45": {
    ...
    members: [
      ...
      "Original Insight Reviewer",
      "SEO Search Intent Lead",
      "AEO Answer Engine Lead",
      "Internal Linking Reviewer",
      "Headline and Opening Reviewer",
      "Authority and Conversion Chair",
    ],
  },
  "blotato-script-quality": {
    ...
    members: [
      ...
      "Hook and Retention Editor",
      "Short-form Narrative Editor",
      "Narrative Arc Editor",
      "Storyboard Continuity Director",
      "Visual Continuity Director",
      "Voiceover Pacing Editor",
      "Short-form Engagement Editor",
      "Platform Fit Reviewer",
      "Caption Readability Reviewer",
      "Publishing Readiness Chair",
      "Short-form Shareability Reviewer",
      "First-frame Packaging Reviewer",
      "Emotional Pull Reviewer",
      "Independent Short-form Red-Team",
    ],
  },
  "zernio-social-copy": {
    ...
    members: [
      ...
      "Social Hook Editor",
      "Engagement and Conversation Reviewer",
      "Dynamic Hashtag Strategist",
      "Visual-Copy Alignment Reviewer",
      "Cross-Platform Coherence Reviewer",
    ],
  },
  "zernio-mini-series": {
  ...
  "zernio-ebook-conversion": {
    ...
    members: [
      ...
      "Benefit-led Headline Reviewer",
      "Commercial Relevance Reviewer",
      "Purchase Friction Reviewer",
      "Social Proof Integrity Reviewer",
    ],
  },
  "quiz-logic": {
  ...
  "podcast-on-brand": {
    ...
    members: [
      ...
      "Conversational Voice Director",
      "Repetition and Pacing Editor",
      "Narrative Arc Reviewer",
      "TTS Performance Reviewer",
      "Ending and Takeaway Reviewer",
      "Podcast Keyword Strategist",
      "Transcript AEO Utility Reviewer",
    ],
  },
  "newsletter-editorial": {
    ...
    members: [
      ...
      "Publishing Readiness Chair",
      "Cross-Channel Duplication Reviewer",
      "Practical Tool/Workflow Reviewer",
      "Reader Interaction Reviewer",
      "Independent Newsletter Red-Team",
    ],
  },
  "social-performance": {
