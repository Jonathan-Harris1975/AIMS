...
export async function buildHeroImagePrompt({ profile, heroHeadline, sessionId }) {
  const messages = [
    {
      ...
      content:
        ...
        "illustration of a daily AI newsletter. Style: clean, modern editorial illustration, " +
        "abstract/conceptual rather than literal, no text or logos in the image, no depictions " +
        "of real named people. Respond with ONLY the prompt text, nothing else.",
    },
  ...
  return `Editorial illustration for an AI newsletter, themed around: ${heroHeadline}`;
}
