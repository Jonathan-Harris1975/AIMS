...
import { json, nowIso, parseJson, placeholders, rows, text } from "./commsOperationsRepositorySupport.js";
import { CommsIdentityArchiveRepository } from "./commsIdentityArchiveRepository.js";

const OPERATIONAL_STATUSES = new Set([
  "open", "pending", "snoozed", "resolved", "blocked", "quarantined", "archived", "escalated",
]);

export class CommsOperationsRepository extends CommsIdentityArchiveRepository {
  constructor(d1) {
    super(d1);
  }
