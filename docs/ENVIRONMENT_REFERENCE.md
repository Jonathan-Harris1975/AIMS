...
| `AI_TIMEOUT` | Yes | services/artwork/createPodcastArtwork.js:14<br>services/artwork/createQuizArtwork.js:11<br>services/blotato/utils/newsShortsService.js:1254<br>services/script/utils/getSponsor.js:38<br>services/tts/utils/mergeProcessor.js:26 |
...
| `BLOTATO_DEFAULT_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1055 |
| `BLOTATO_DEFAULT_FOLLOW_CTA` | Yes | services/blotato/utils/newsShortsService.js:210 |
| `BLOTATO_FACEBOOK_MEDIA_TYPE` | Yes | services/blotato/utils/autoPublishService.js:882 |
| `BLOTATO_FACEBOOK_PAGE_ID` | Yes | services/blotato/utils/autoPublishService.js:736<br>services/blotato/utils/autoPublishService.js:879 |
| `BLOTATO_FACEBOOK_SUBACCOUNT_ID` | No | services/blotato/utils/autoPublishService.js:736<br>services/blotato/utils/autoPublishService.js:879 |
...
| `BLOTATO_INLINE_PUBLISH_JOBS` | No | services/blotato/utils/autoPublishService.js:2008 |
| `BLOTATO_INSTAGRAM_SHARE_TO_FEED` | Yes | services/blotato/utils/autoPublishService.js:848 |
| `BLOTATO_KEEPALIVE_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1250 |
| `BLOTATO_LOW_COST_IMAGE_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:427<br>services/blotato/utils/newsShortsService.js:29 |
| `BLOTATO_LOW_COST_VIDEO_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:428<br>services/blotato/utils/newsShortsService.js:30 |
| `BLOTATO_NEWS_AUDIENCE` | No | services/blotato/utils/autoPublishService.js:1289 |
| `BLOTATO_NEWS_CTA` | Yes | services/blotato/utils/autoPublishService.js:1294 |
| `BLOTATO_NEWS_DURATION_SECONDS` | Yes | services/blotato/utils/autoPublishService.js:1287 |
| `BLOTATO_NEWS_JSON_RESPONSE_FORMAT` | Yes | services/blotato/utils/newsShortsService.js:1229 |
...
| `BLOTATO_NEWS_RESPONSE_FORMAT_MODE` | Yes | services/blotato/utils/newsShortsService.js:1232 |
...
| `BLOTATO_NEWS_TEMPLATE_ID` | Yes | services/blotato/utils/autoPublishService.js:1068<br>services/blotato/utils/autoPublishService.js:1069 |
| `BLOTATO_NEWS_TEMPLATE_SEARCH` | Yes | services/blotato/utils/autoPublishService.js:304<br>services/blotato/utils/autoPublishService.js:1073 |
| `BLOTATO_NEWS_THEME` | No | services/blotato/utils/autoPublishService.js:1286 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_ACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:696 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_SUBACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:744<br>services/blotato/utils/autoPublishService.js:772 |
| `BLOTATO_PUBLISH_SEQUENTIAL` | Yes | services/blotato/utils/autoPublishService.js:1033 |
| `BLOTATO_PUBLISH_STAGGER_MS` | Yes | services/blotato/utils/autoPublishService.js:1032 |
...
| `BLOTATO_RENDERED_QA_BLOCK_SOFT_FAILURES` | Yes | services/blotato/utils/autoPublishService.js:1547 |
...
| `BLOTATO_REQUIRE_ALL_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1676 |
| `BLOTATO_REQUIRE_SCHEDULE_CONFIRMATION` | Yes | services/blotato/utils/autoPublishService.js:960 |
...
| `BLOTATO_RSS_PICK_MODE` | Yes | services/blotato/utils/autoPublishService.js:1074<br>services/blotato/utils/rssArticlePicker.js:67<br>services/blotato/utils/rssArticleSource.js:220 |
...
| `BLOTATO_SCHEDULE_RECOVERY_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1216 |
| `BLOTATO_SCRIPT_TIMEOUT_MS` | Yes | services/blotato/utils/newsShortsService.js:1254 |
| `BLOTATO_STEP0_PREFLIGHT_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:788 |
| `BLOTATO_TEMPLATE_AUTO_DISCOVERY` | Yes | services/blotato/utils/autoPublishService.js:302<br>services/blotato/utils/autoPublishService.js:1072 |
| `BLOTATO_TEMPLATE_ID_MODE` | Yes | services/blotato/utils/autoPublishService.js:123<br>services/blotato/utils/autoPublishService.js:1070 |
| `BLOTATO_TEMPLATE_SEARCH` | No | services/blotato/utils/autoPublishService.js:304<br>services/blotato/utils/autoPublishService.js:1073 |
| `BLOTATO_TEMPLATE_VERIFY` | Yes | services/blotato/utils/autoPublishService.js:300<br>services/blotato/utils/autoPublishService.js:1071 |
| `BLOTATO_TEXT_TO_IMAGE_MODEL` | Yes | services/blotato/utils/autoPublishService.js:427 |
...
| `BLOTATO_TIKTOK_DISABLED_COMMENTS` | Yes | services/blotato/utils/autoPublishService.js:869 |
| `BLOTATO_TIKTOK_DISABLED_DUET` | Yes | services/blotato/utils/autoPublishService.js:870 |
| `BLOTATO_TIKTOK_DISABLED_STITCH` | Yes | services/blotato/utils/autoPublishService.js:871 |
| `BLOTATO_TIKTOK_IS_AI_GENERATED` | Yes | services/blotato/utils/autoPublishService.js:874 |
| `BLOTATO_TIKTOK_IS_BRANDED_CONTENT` | Yes | services/blotato/utils/autoPublishService.js:872 |
| `BLOTATO_TIKTOK_IS_YOUR_BRAND` | Yes | services/blotato/utils/autoPublishService.js:873 |
| `BLOTATO_TIKTOK_PRIVACY_LEVEL` | Yes | services/blotato/utils/autoPublishService.js:868 |
| `BLOTATO_TIMEOUT_MS` | Yes | services/blotato/utils/blotatoClient.js:151 |
| `BLOTATO_USE_BRAND_KIT` | Yes | services/blotato/utils/autoPublishService.js:536 |
| `BLOTATO_USE_MANUAL_TEMPLATE_INPUTS` | Yes | services/blotato/utils/autoPublishService.js:535 |
...
| `COMMS_HUB_CONTENT_AUTOMATION_BLOTATO_VIDEO_BRIEF_LIMIT` | Yes | services/blotato/utils/autoPublishService.js:1917 |
...
| `ZERNIO_MINI_SERIES_RETRY_BASE_MS` | Yes | services/zernio/utils/socialScheduler.js:2518 |
...
| `ZERNIO_SCHEDULE_TIME_TOLERANCE_MS` | Yes | services/zernio/utils/socialScheduler.js:839 |
