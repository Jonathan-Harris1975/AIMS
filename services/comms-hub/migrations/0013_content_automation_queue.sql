...
CREATE TABLE comms_hub_delayed_actions_v4 (
  ...
  action_type TEXT NOT NULL CHECK(action_type IN ('reminder','reply','reply_draft','email_reply','form_reply','recheck','sla_warning','sla_breach','retention','notification','attachment_ingest','outreach_follow_up','outreach_reply_process','content_automation')),
...
INSERT INTO comms_hub_delayed_actions_v4 (
...
ALTER TABLE comms_hub_delayed_actions_v4 RENAME TO comms_hub_delayed_actions;
