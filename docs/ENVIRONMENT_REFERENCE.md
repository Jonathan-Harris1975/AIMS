...
| `AIMS_API_KEY` | Yes | server.js:196<br>services/ops/index.js:402<br>services/shared/middleware/suiteAuth.js:55 |
...
| `BLOTATO_DEFAULT_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1400 |
| `BLOTATO_DEFAULT_FOLLOW_CTA` | Yes | services/blotato/utils/newsShortsService.js:230 |
| `BLOTATO_FACEBOOK_MEDIA_TYPE` | Yes | services/blotato/utils/autoPublishService.js:1024 |
| `BLOTATO_FACEBOOK_PAGE_ID` | Yes | services/blotato/utils/autoPublishService.js:878<br>services/blotato/utils/autoPublishService.js:1021 |
| `BLOTATO_FACEBOOK_SUBACCOUNT_ID` | No | services/blotato/utils/autoPublishService.js:878<br>services/blotato/utils/autoPublishService.js:1021 |
...
| `BLOTATO_PUBLISH_STAGGER_MS` | Yes | services/blotato/utils/autoPublishService.js:1359 |
...
| `BLOTATO_TEMPLATE_ID_MODE` | Yes | services/blotato/utils/autoPublishService.js:167<br>services/blotato/utils/autoPublishService.js:1415 |
| `BLOTATO_TEMPLATE_SEARCH` | No | services/blotato/utils/autoPublishService.js:348<br>services/blotato/utils/autoPublishService.js:1418 |
| `BLOTATO_TEMPLATE_VERIFY` | Yes | services/blotato/utils/autoPublishService.js:344<br>services/blotato/utils/autoPublishService.js:1416 |
...
| `BLOTATO_TIKTOK_DISABLED_COMMENTS` | Yes | services/blotato/utils/autoPublishService.js:1011 |
| `BLOTATO_TIKTOK_DISABLED_DUET` | Yes | services/blotato/utils/autoPublishService.js:1012 |
| `BLOTATO_TIKTOK_DISABLED_STITCH` | Yes | services/blotato/utils/autoPublishService.js:1013 |
| `BLOTATO_TIKTOK_IS_AI_GENERATED` | Yes | services/blotato/utils/autoPublishService.js:1016 |
| `BLOTATO_TIKTOK_IS_BRANDED_CONTENT` | Yes | services/blotato/utils/autoPublishService.js:1014 |
| `BLOTATO_TIKTOK_IS_YOUR_BRAND` | Yes | services/blotato/utils/autoPublishService.js:1015 |
| `BLOTATO_TIKTOK_PRIVACY_LEVEL` | Yes | services/blotato/utils/autoPublishService.js:1010 |
...
| `BLOTATO_YOUTUBE_NOTIFY_SUBSCRIBERS` | Yes | services/blotato/utils/autoPublishService.js:1000 |
| `BLOTATO_YOUTUBE_PRIVACY_STATUS` | Yes | services/blotato/utils/autoPublishService.js:999 |
...
| `PORT` | Yes | routes/podcast-pipeline.js:14<br>scripts/deploySmoke.js:3<br>scripts/startupCheck.js:67<br>server.js:481<br>services/ops/index.js:401 |
