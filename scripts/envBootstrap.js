...
export const ENV = {
  ...
  BLOTATO_DEFAULT_TEMPLATE_ID: opt("BLOTATO_DEFAULT_TEMPLATE_ID", "5903fe43-514d-40ee-a060-0d6628c5f8fd"),
  ...
  BLOTATO_SOURCE_POLL_TIMEOUT_MS: num("BLOTATO_SOURCE_POLL_TIMEOUT_MS", 180000),
  BLOTATO_SOURCE_POLL_INTERVAL_MS: num("BLOTATO_SOURCE_POLL_INTERVAL_MS", 3000),
  BLOTATO_VISUAL_POLL_TIMEOUT_MS: num("BLOTATO_VISUAL_POLL_TIMEOUT_MS", 420000),
  BLOTATO_VISUAL_POLL_INTERVAL_MS: num("BLOTATO_VISUAL_POLL_INTERVAL_MS", 5000),
  BLOTATO_POST_POLL_TIMEOUT_MS: num("BLOTATO_POST_POLL_TIMEOUT_MS", 180000),
  BLOTATO_POST_POLL_INTERVAL_MS: num("BLOTATO_POST_POLL_INTERVAL_MS", 5000),
