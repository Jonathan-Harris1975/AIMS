...
export const ENV = {
  ...
  PODCAST_SYNTHESIS_MAX_TOKENS: num("PODCAST_SYNTHESIS_MAX_TOKENS", 8192),
  PODCAST_SYNTHESIS_TIMEOUT_MS: num("PODCAST_SYNTHESIS_TIMEOUT_MS", 180000),
  PODCAST_EDITORIAL_MAX_TOKENS: num("PODCAST_EDITORIAL_MAX_TOKENS", 8192),
  PODCAST_EDITORIAL_TIMEOUT_MS: num("PODCAST_EDITORIAL_TIMEOUT_MS", 180000),
  PODCAST_REPAIR_MAX_TOKENS: num("PODCAST_REPAIR_MAX_TOKENS", 8192),
  PODCAST_REPAIR_TIMEOUT_MS: num("PODCAST_REPAIR_TIMEOUT_MS", 180000),
