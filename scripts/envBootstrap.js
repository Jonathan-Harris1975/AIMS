...
const num = (k, d = undefined) => {
  ...
  const n = Number(raw);
  if (Number.isNaN(n)) throw new Error(`Env ${k} must be numeric (got "${raw}")`);
  return n;
};
...
/* ============================================================
   ...
   - Includes: all Koyeb vars + repo-only vars found in code
============================================================ */
export const ENV = {
  // Core
  ...
  // Funding + iTunes fields (lowercase in your env list)
  ...
  // AWS (present in Koyeb list; may be unused in code right now)
  ...
  /* ============================================================
     Repo-only envs found in code (not in your Koyeb list)
     Decide whether to add them to Koyeb or remove/rename in code.
  ============================================================ */
