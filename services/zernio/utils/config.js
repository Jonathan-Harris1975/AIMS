...
const DEFAULT_STORED_IMAGE_URL = `${DAILY_IMAGE_BASE}/site-logo`;
...
export const MINI_SERIES_CONFIG = {
  ...
  fallbackImageUrl: trimString(process.env.ZERNIO_MINI_SERIES_IMAGE_URL, DEFAULT_STORED_IMAGE_URL),
  publishTimes: {
