-- Durable web-chat AI retries.
-- Adds a delayed-action type that survives process restarts after the initial
-- low-latency queueMicrotask attempt has accepted the visitor message.

CREATE TABLE comms_hub_delayed_actions_v5 (
  id TEXT PRIMARY KEY,
  conversation_id TEXT NOT NULL,
  action_type TEXT NOT NULL CHECK(action_type IN ('reminder','reply','reply_draft','email_reply','form_reply','recheck','sla_warning','sla_breach','retention','notification','attachment_ingest','outreach_follow_up','outreach_reply_process','content_automation','chat_ai_retry')),
...
INSERT INTO comms_hub_delayed_actions_v5 (
...
ALTER TABLE comms_hub_delayed_actions_v5 RENAME TO comms_hub_delayed_actions;
