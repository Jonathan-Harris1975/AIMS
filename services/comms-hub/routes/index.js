  ...
  router.get("/health", (_req, res) => {
    ...
    return res.status(ready ? 200 : 503).json({
      ...
      capabilities: {
        ...
        contentAutomation: booleanValue(process.env.COMMS_HUB_CONTENT_AUTOMATION_ENABLED, false),
        contentAutomationLanes: {
          blog: booleanValue(process.env.COMMS_HUB_CONTENT_AUTOMATION_BLOG_ENABLED, true),
          social: booleanValue(process.env.COMMS_HUB_CONTENT_AUTOMATION_SOCIAL_ENABLED, true),
