...
const anthropic46 = provider(
  ...
  [...SHARED_OPENROUTER_KEY, "OPENROUTER_API_KEY_ANTHROPIC_4_6", "OPENROUTER_API_KEY_ANTHROPIC_4-6", "OPENROUTER_API_KEY_ANTHROPIC_4.6", "OPENROUTER_API_KEY_ANTHROPIC_46",
...
const google25FlashLite = provider(
  ...
  [...SHARED_OPENROUTER_KEY, "OPENROUTER_API_KEY_GOOGLE_2_5_flashlite", "OPENROUTER_API_KEY_GOOGLE_2-5_flashlite", "OPENROUTER_API_KEY_GOOGLE_2.5_flashlite",
     "OPENROUTER_API_KEY_GOOGLE_25_FLASHLITE", "OPENROUTER_API_KEY_GOOGLE"]
);
...
const claudeOpus = provider(
  "claudeOpus",
  ["OPENROUTER_CLAUDE_OPUS", "OPENROUTER_CLAUDE_OPUS_4_7", "OPENROUTER_ANTHROPIC_OPUS_4_7"],
  [...SHARED_OPENROUTER_KEY, "OPENROUTER_API_KEY_CLAUDE_OPUS", "OPENROUTER_API_KEY_CLAUDE_OPUS_4_7", "OPENROUTER_API_KEY_ANTHROPIC_OPUS_4_7"]
);
...
const modelRegistry = {
  ...
  claudeSonnet5,
  claudeOpus,
  // Compatibility alias for callers that still inspect the historical ID.
  claudeOpus47: claudeOpus,
  gpt56Sol,
  commsFreePrimary,
  commsFreeBackup,
  commsFreeFallback,
...
export const aiConfig = {
  ...
  routeModels: {
    ...
    scriptMainSynthesis: fixedRouteChain(["claudeSonnet5", "gpt56Sol", "claudeOpus"]),
    ...
    editorialPass: fixedRouteChain(["claudeOpus", "gpt56Sol", "claudeSonnet5"]),
