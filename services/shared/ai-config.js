...
const claudeOpus46 = provider(
  "claudeOpus46",
  ["OPENROUTER_CLAUDE_OPUS_4_6", "OPENROUTER_ANTHROPIC_OPUS_4_6"],
  [...SHARED_OPENROUTER_KEY, "OPENROUTER_API_KEY_CLAUDE_OPUS_4_6", "OPENROUTER_API_KEY_ANTHROPIC_OPUS_4_6"]
);
...
export const aiConfig = {
  ...
  routeModels: {
    ...
    rssRewrite: routeChain(["standard", "highQuality", "fast", "fallback"], ["gpt56Sol", "google25FlashLite"]),
    rssShortTitle: routeChain(["fast", "summary", "fallback"], ["gpt56Luna", "google25FlashLite"]),
    blogWeekly: routeChain(["claudeOpus46", "highQuality", "standard", "fallback"], ["gpt56Sol", "google25FlashLite"]),
    blogSocial: routeChain(["highQuality", "standard", "fallback"], ["gpt56Sol", "google25FlashLite"]),
    ...
    zernioEbook: routeChain(["highQuality", "standard", "fallback"], ["gpt56Sol", "google25FlashLite"]),
