...
| `BLOTATO_DEFAULT_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1072 |
| `BLOTATO_DEFAULT_FOLLOW_CTA` | Yes | services/blotato/utils/newsShortsService.js:230 |
| `BLOTATO_FACEBOOK_MEDIA_TYPE` | Yes | services/blotato/utils/autoPublishService.js:899 |
| `BLOTATO_FACEBOOK_PAGE_ID` | Yes | services/blotato/utils/autoPublishService.js:753<br>services/blotato/utils/autoPublishService.js:896 |
| `BLOTATO_FACEBOOK_SUBACCOUNT_ID` | No | services/blotato/utils/autoPublishService.js:753<br>services/blotato/utils/autoPublishService.js:896 |
...
| `BLOTATO_IMAGE_TO_VIDEO_MODEL` | Yes | services/blotato/utils/autoPublishService.js:436 |
| `BLOTATO_INLINE_PUBLISH_JOBS` | No | services/blotato/utils/autoPublishService.js:2097 |
| `BLOTATO_INSTAGRAM_SHARE_TO_FEED` | Yes | services/blotato/utils/autoPublishService.js:865 |
| `BLOTATO_KEEPALIVE_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1307 |
| `BLOTATO_LOW_COST_IMAGE_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:435<br>services/blotato/utils/newsShortsService.js:30 |
| `BLOTATO_LOW_COST_VIDEO_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:436<br>services/blotato/utils/newsShortsService.js:31 |
| `BLOTATO_NEWS_AUDIENCE` | No | services/blotato/utils/autoPublishService.js:1348 |
| `BLOTATO_NEWS_CTA` | Yes | services/blotato/utils/autoPublishService.js:1353 |
| `BLOTATO_NEWS_DURATION_SECONDS` | Yes | services/blotato/utils/autoPublishService.js:1346 |
...
| `BLOTATO_NEWS_TEMPLATE_ID` | Yes | services/blotato/utils/autoPublishService.js:1085<br>services/blotato/utils/autoPublishService.js:1086 |
| `BLOTATO_NEWS_TEMPLATE_SEARCH` | Yes | services/blotato/utils/autoPublishService.js:312<br>services/blotato/utils/autoPublishService.js:1090 |
| `BLOTATO_NEWS_THEME` | No | services/blotato/utils/autoPublishService.js:1344 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_ACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:713 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_SUBACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:761<br>services/blotato/utils/autoPublishService.js:789 |
| `BLOTATO_PUBLISH_SEQUENTIAL` | Yes | services/blotato/utils/autoPublishService.js:1050 |
| `BLOTATO_PUBLISH_STAGGER_MS` | Yes | services/blotato/utils/autoPublishService.js:1049 |
...
| `BLOTATO_RENDERED_QA_BLOCK_SOFT_FAILURES` | Yes | services/blotato/utils/autoPublishService.js:1606 |
...
| `BLOTATO_REQUIRE_ALL_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1735 |
| `BLOTATO_REQUIRE_SCHEDULE_CONFIRMATION` | Yes | services/blotato/utils/autoPublishService.js:977 |
...
| `BLOTATO_RSS_PICK_MODE` | Yes | services/blotato/utils/autoPublishService.js:1091<br>services/blotato/utils/rssArticlePicker.js:67<br>services/blotato/utils/rssArticleSource.js:220 |
...
| `BLOTATO_SCHEDULE_RECOVERY_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1272 |
| `BLOTATO_SCRIPT_TIMEOUT_MS` | Yes | services/blotato/utils/newsShortsService.js:1313 |
| `BLOTATO_STEP0_PREFLIGHT_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:805 |
| `BLOTATO_TEMPLATE_AUTO_DISCOVERY` | Yes | services/blotato/utils/autoPublishService.js:310<br>services/blotato/utils/autoPublishService.js:1089 |
| `BLOTATO_TEMPLATE_ID_MODE` | Yes | services/blotato/utils/autoPublishService.js:131<br>services/blotato/utils/autoPublishService.js:1087 |
| `BLOTATO_TEMPLATE_SEARCH` | No | services/blotato/utils/autoPublishService.js:312<br>services/blotato/utils/autoPublishService.js:1090 |
| `BLOTATO_TEMPLATE_VERIFY` | Yes | services/blotato/utils/autoPublishService.js:308<br>services/blotato/utils/autoPublishService.js:1088 |
| `BLOTATO_TEXT_TO_IMAGE_MODEL` | Yes | services/blotato/utils/autoPublishService.js:435<br>services/blotato/utils/newsShortsService.js:46 |
...
| `BLOTATO_TIKTOK_DISABLED_COMMENTS` | Yes | services/blotato/utils/autoPublishService.js:886 |
| `BLOTATO_TIKTOK_DISABLED_DUET` | Yes | services/blotato/utils/autoPublishService.js:887 |
| `BLOTATO_TIKTOK_DISABLED_STITCH` | Yes | services/blotato/utils/autoPublishService.js:888 |
| `BLOTATO_TIKTOK_IS_AI_GENERATED` | Yes | services/blotato/utils/autoPublishService.js:891 |
| `BLOTATO_TIKTOK_IS_BRANDED_CONTENT` | Yes | services/blotato/utils/autoPublishService.js:889 |
| `BLOTATO_TIKTOK_IS_YOUR_BRAND` | Yes | services/blotato/utils/autoPublishService.js:890 |
| `BLOTATO_TIKTOK_PRIVACY_LEVEL` | Yes | services/blotato/utils/autoPublishService.js:885 |
| `BLOTATO_TIMEOUT_MS` | Yes | services/blotato/utils/blotatoClient.js:151 |
| `BLOTATO_USE_BRAND_KIT` | Yes | services/blotato/utils/autoPublishService.js:550 |
| `BLOTATO_USE_MANUAL_TEMPLATE_INPUTS` | Yes | services/blotato/utils/autoPublishService.js:543 |
...
| `BLOTATO_YOUTUBE_NOTIFY_SUBSCRIBERS` | Yes | services/blotato/utils/autoPublishService.js:875 |
| `BLOTATO_YOUTUBE_PRIVACY_STATUS` | Yes | services/blotato/utils/autoPublishService.js:874 |
...
| `COMMS_HUB_CONTENT_AUTOMATION_BLOTATO_VIDEO_BRIEF_LIMIT` | Yes | services/blotato/utils/autoPublishService.js:1994 |
