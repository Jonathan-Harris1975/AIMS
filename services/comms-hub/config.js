...
export function getCommsHubReadiness(env = process.env) {
  ...
  return {
    ...
    channels: {
      ...
      emailArchive: booleanValue(env.COMMS_HUB_EMAIL_ARCHIVE_ENABLED, true),
...
export function loadCommsHubConfig(env = process.env, { requireEnabled = false } = {}) {
  ...
  return Object.freeze({
    ...
    autoSendEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_ENABLED, aiEnabled),
    autoSendChatEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_CHAT_ENABLED, true),
    autoSendEmailEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_EMAIL_ENABLED, true),
    autoSendSocialEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_SOCIAL_ENABLED, true),
    autoSendFormEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_FORM_ENABLED, booleanValue(env.COMMS_HUB_FORM_AUTO_SEND_ENABLED, aiEnabled)),
    formAutoSendEnabled: booleanValue(env.COMMS_HUB_AUTO_SEND_FORM_ENABLED, booleanValue(env.COMMS_HUB_FORM_AUTO_SEND_ENABLED, aiEnabled)),
    ...
    contentAutomationBlotatoVideoEnabled: booleanValue(env.COMMS_HUB_CONTENT_AUTOMATION_BLOTATO_VIDEO_ENABLED, true),
    contentAutomationZernioMiniSeriesEnabled: booleanValue(env.COMMS_HUB_CONTENT_AUTOMATION_ZERNIO_MINI_SERIES_ENABLED, true),
    contentAutomationQualityMinimumScore: decimalValue(env.COMMS_HUB_CONTENT_QUALITY_MIN_SCORE, 0.78, "COMMS_HUB_CONTENT_QUALITY_MIN_SCORE"),
    ...
    callbackEmailCaptureEnabled: booleanValue(env.COMMS_HUB_CALLBACK_EMAIL_CAPTURE_ENABLED, false),
    ...
    followUpPollMs: positiveInteger(env.COMMS_HUB_FOLLOW_UP_POLL_MS, 900_000, "COMMS_HUB_FOLLOW_UP_POLL_MS", { min: 30_000, max: 3_600_000 }),
    ...
    providerHealthPollMs: positiveInteger(env.COMMS_HUB_PROVIDER_HEALTH_POLL_MS, 900_000, "COMMS_HUB_PROVIDER_HEALTH_POLL_MS", { min: 30_000, max: 3_600_000 }),
    ...
    archivePollMs: positiveInteger(env.COMMS_HUB_ARCHIVE_POLL_MS, 300_000, "COMMS_HUB_ARCHIVE_POLL_MS", { min: 5_000, max: 3_600_000 }),
    ...
    socialPollMs: positiveInteger(env.COMMS_HUB_ZERNIO_POLL_MS, 3_600_000, "COMMS_HUB_ZERNIO_POLL_MS", { min: 30_000, max: 3_600_000 }),
    ...
    emailArchiveEnabled: booleanValue(env.COMMS_HUB_EMAIL_ARCHIVE_ENABLED, true),
    emailArchiveAfterDays: positiveInteger(env.COMMS_HUB_EMAIL_ARCHIVE_AFTER_DAYS, 90, "COMMS_HUB_EMAIL_ARCHIVE_AFTER_DAYS", { min: 30, max: 3650 }),
    emailArchiveBatchSize: positiveInteger(env.COMMS_HUB_EMAIL_ARCHIVE_BATCH_SIZE, 100, "COMMS_HUB_EMAIL_ARCHIVE_BATCH_SIZE", { min: 1, max: 250 }),
    ...
    emailStartupRecoveryUidLookback: positiveInteger(env.COMMS_HUB_EMAIL_STARTUP_RECOVERY_UID_LOOKBACK, 25, "COMMS_HUB_EMAIL_STARTUP_RECOVERY_UID_LOOKBACK", { min: 1, max: 100 }),
    emailStartupRecoveryMaxAgeDays: positiveInteger(env.COMMS_HUB_EMAIL_STARTUP_RECOVERY_MAX_AGE_DAYS, 14, "COMMS_HUB_EMAIL_STARTUP_RECOVERY_MAX_AGE_DAYS", { min: 1, max: 30 }),
    emailManualRecoveryUidLookback: positiveInteger(env.COMMS_HUB_EMAIL_MANUAL_RECOVERY_UID_LOOKBACK, 100, "COMMS_HUB_EMAIL_MANUAL_RECOVERY_UID_LOOKBACK", { min: 1, max: 100 }),
    ...
    delayedActionPollMs: positiveInteger(env.COMMS_HUB_DELAYED_ACTION_POLL_MS, 300_000, "COMMS_HUB_DELAYED_ACTION_POLL_MS", { min: 30_000, max: 3_600_000 }),
    ...
    housekeepingEnabled: booleanValue(env.COMMS_HUB_HOUSEKEEPING_ENABLED, true),
    housekeepingWorkerEnabled: booleanValue(env.COMMS_HUB_HOUSEKEEPING_WORKER_ENABLED, true),
    housekeepingPollMs: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_POLL_MS, 86_400_000, "COMMS_HUB_HOUSEKEEPING_POLL_MS", { min: 3_600_000, max: 604_800_000 }),
    housekeepingCompletedRecordDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_COMPLETED_RECORD_DAYS, 180, "COMMS_HUB_HOUSEKEEPING_COMPLETED_RECORD_DAYS", { min: 30, max: 3650 }),
    housekeepingProviderHealthDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_PROVIDER_HEALTH_DAYS, 90, "COMMS_HUB_HOUSEKEEPING_PROVIDER_HEALTH_DAYS", { min: 7, max: 3650 }),
    housekeepingAuditArchiveEnabled: booleanValue(env.COMMS_HUB_HOUSEKEEPING_AUDIT_ARCHIVE_ENABLED, true),
    housekeepingAuditRetentionDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_AUDIT_RETENTION_DAYS, 365, "COMMS_HUB_HOUSEKEEPING_AUDIT_RETENTION_DAYS", { min: 90, max: 3650 }),
    housekeepingAuditBatchSize: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_AUDIT_BATCH_SIZE, 500, "COMMS_HUB_HOUSEKEEPING_AUDIT_BATCH_SIZE", { min: 1, max: 1000 }),
    housekeepingQuarantineWarningDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_QUARANTINE_WARNING_DAYS, 7, "COMMS_HUB_HOUSEKEEPING_QUARANTINE_WARNING_DAYS", { min: 1, max: 365 }),
    housekeepingOrphanGraceDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_ORPHAN_GRACE_DAYS, 7, "COMMS_HUB_HOUSEKEEPING_ORPHAN_GRACE_DAYS", { min: 1, max: 365 }),
    housekeepingQuarantinedAttachmentDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_QUARANTINED_ATTACHMENT_DAYS, 30, "COMMS_HUB_HOUSEKEEPING_QUARANTINED_ATTACHMENT_DAYS", { min: 7, max: 3650 }),
    housekeepingExportRetentionDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_EXPORT_RETENTION_DAYS, 30, "COMMS_HUB_HOUSEKEEPING_EXPORT_RETENTION_DAYS", { min: 7, max: 3650 }),
    housekeepingR2DeleteLimit: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_R2_DELETE_LIMIT, 250, "COMMS_HUB_HOUSEKEEPING_R2_DELETE_LIMIT", { min: 1, max: 1000 }),
    housekeepingBackupRunsRetained: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_BACKUP_RUNS_RETAINED, 14, "COMMS_HUB_HOUSEKEEPING_BACKUP_RUNS_RETAINED", { min: 3, max: 365 }),
    housekeepingRestoreObjectDays: positiveInteger(env.COMMS_HUB_HOUSEKEEPING_RESTORE_OBJECT_DAYS, 7, "COMMS_HUB_HOUSEKEEPING_RESTORE_OBJECT_DAYS", { min: 1, max: 365 }),
    housekeepingNotificationActor: usableEnvValue(env.COMMS_HUB_HOUSEKEEPING_NOTIFICATION_ACTOR) || "admin",
