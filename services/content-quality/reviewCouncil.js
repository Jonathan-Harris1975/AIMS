...
export const REVIEW_COUNCILS = Object.freeze({
  "rss-rewrite-quarantine": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "RSS Publication Chair", remit: "Chair the review, reconcile specialist findings, enforce source and summary-depth hard gates, and make the final \
publish-or-quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "Source Integrity Reviewer", remit: "Verify the rewritten title and summary remain faithful to the supplied source and contain no invented claims, \
certainty or attribution.", authority: "hard-gate" },
      { seat: 3, role: "RSS Rewrite Editor", remit: "Judge whether the rewrite is genuinely useful, complete and concise enough for feed consumption without collapsing into a \
teaser or fragment.", authority: "hard-gate" },
      { seat: 4, role: "Expert Insight Editor", remit: "Check that the summary preserves the source's practical significance and does not strip away the consequence, tension \
or useful context.", authority: "advisory" },
      { seat: 5, role: "British English Language Expert", remit: "Enforce natural British English vocabulary, spelling and idiom outside immutable source quotations or names.",
         authority: "hard-gate" },
      { seat: 6, role: "Grammar, Spelling and Punctuation Expert", remit:
         "Remove grammatical errors, malformed punctuation, sentence fragments and formatting defects that reduce publication quality.", authority: "hard-gate" },
      { seat: 7, role: "Anti-Hype Reviewer", remit: "Challenge promotional inflation, vague superlatives and unsupported dramatic framing while preserving genuine \
significance.", authority: "hard-gate" },
      { seat: 8, role: "AEO Clarity Reviewer", remit: "Ensure the summary states the subject, development and practical meaning directly enough to be useful to people and \
answer engines.", authority: "advisory" },
  ...
  "blog-phase45": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Long-form Editorial Chair", remit: "Chair the meeting, reconcile editorial, search, evidence and conversion findings, and make the final bounded \
publish-or-quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "Source Evidence Reviewer", remit: "Verify factual statements, attribution and evidence against supplied sources and block unsupported certainty or \
invented detail.", authority: "hard-gate" },
      { seat: 3, role: "Argument and Structure Reviewer", remit: "Test whether the article has a coherent thesis, logical progression, useful section order and a conclusion \
earned by the evidence.", authority: "hard-gate" },
      { seat: 4, role: "Original Insight Reviewer", remit: "Require meaningful interpretation or judgement beyond competent source summarisation so the article earns Jonathan \
Harris's byline.", authority: "hard-gate" },
      { seat: 5, role: "Jonathan Harris Voice Editor", remit: "Protect Jonathan's direct, sceptical, practical British voice and remove generic AI-editorial phrasing or \
performative expertise.", authority: "hard-gate" },
      ...
      { seat: 7, role: "Grammar, Spelling and Punctuation Expert", remit:
         "Correct grammar, punctuation, sentence construction and mechanical defects without flattening voice.", authority: "hard-gate" },
      { seat: 8, role: "Headline and Opening Reviewer", remit: "Judge whether the headline and opening create a specific reason to continue without clickbait, throat-clearing \
or generic scene-setting.", authority: "hard-gate" },
      { seat: 9, role: "SEO Search Intent Lead", remit: "Check title, headings and topical coverage against the article's genuine search intent without keyword stuffing or \
topic drift.", authority: "advisory" },
      { seat: 10, role: "AEO Answer Engine Lead", remit: "Improve direct-answer utility, extractable explanations and semantic clarity while preserving natural editorial \
flow.", authority: "advisory" },
      { seat: 11, role: "Internal Linking Reviewer", remit: "Check that internal links are relevant, real, non-duplicative and useful to the reader rather than decorative SEO \
links.", authority: "hard-gate" },
      { seat: 12, role: "Schema Integrity Reviewer", remit: "Verify structured metadata and publishing schema accurately describe the article and do not overclaim content not \
present on the page.", authority: "hard-gate" },
      { seat: 13, role: "Mobile UX Reader", remit: "Review paragraph length, heading rhythm and scanning behaviour for realistic mobile reading rather than desktop-only prose \
blocks.", authority: "advisory" },
      { seat: 14, role: "Organic Growth Editor", remit: "Identify useful discoverability and shareability improvements grounded in the article rather than generic growth \
tactics.", authority: "advisory" },
      { seat: 15, role: "Authority and Conversion Reviewer", remit: "Check that authority, calls to action and commercial pathways are credible, proportionate and relevant to \
the article's reader intent.", authority: "hard-gate" },
      { seat: 16, role: "Digital Content Performance Reviewer", remit: "Assess readability, usefulness, likely retention and content packaging against professional digital \
publishing standards.", authority: "advisory" },
      ...
      { seat: 18, role: "Brand Tone Reviewer", remit: "Block hype, corporate sludge, motivational filler and tone that conflicts with the wider Jonathan Harris publishing \
brand.", authority: "hard-gate" },
      { seat: 19, role: "Independent Blog Red-Team", remit: "Challenge groupthink, weak evidence, overlong repairs and recommendations that exceed the defect actually \
observed.", authority: "challenge" },
    ],
  },
  "blotato-script-quality": {
    ...
    members: [
      { seat: 1, role: "Short-form Editorial Chair", remit: "Chair the meeting, reconcile story, visual, source and platform findings, and make the final render-ready or \
quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "Source Fidelity Reviewer", remit: "Verify every factual claim, named entity and implication against the supplied source material before any creative \
optimisation is accepted.", authority: "hard-gate" },
      { seat: 3, role: "Jonathan Harris Voice Editor", remit: "Protect Jonathan's sceptical, practical voice and reject generic creator language, hype or artificial \
enthusiasm.", authority: "hard-gate" },
      { seat: 4, role: "Hook and Retention Editor", remit: "Judge whether the opening earns attention immediately and whether each beat gives the viewer a reason to continue.",
         authority: "hard-gate" },
      ...
      { seat: 6, role: "Narrative Arc Editor", remit: "Verify the explicit whole-video narrative arc matches the script and scenes and contains a meaningful progression or \
reveal.", authority: "hard-gate" },
      { seat: 7, role: "Storyboard Continuity Director", remit: "Ensure adjacent scenes logically and visually progress from the same story instead of behaving like unrelated \
stock clips.", authority: "hard-gate" },
      ...
      { seat: 9, role: "Voiceover Pacing Editor", remit: "Check spoken rhythm, sentence length and beat density for natural short-form delivery without rushed or dead \
sections.", authority: "advisory" },
      { seat: 10, role: "First-frame Packaging Reviewer", remit: "Judge the opening frame and thumbnail concept for immediate clarity and stopping power without deceptive \
packaging.", authority: "hard-gate" },
      { seat: 11, role: "Emotional Pull Reviewer", remit: "Check that the short creates curiosity, surprise, concern, recognition or useful tension without manufacturing \
emotion unsupported by the story.", authority: "advisory" },
      { seat: 12, role: "Short-form Shareability Reviewer", remit: "Assess whether the final idea gives viewers a credible reason to save, send or discuss the short rather \
than relying on engagement bait.", authority: "advisory" },
      ...
      { seat: 14, role: "Caption Readability Reviewer", remit: "Ensure caption copy is concise, legible, source-faithful and complementary to the video rather than duplicating \
the entire script.", authority: "advisory" },
      ...
      { seat: 17, role: "Publishing Readiness Reviewer", remit: "Confirm required fields, scenes, media instructions and platform payloads are complete before rendering \
begins.", authority: "hard-gate" },
      { seat: 18, role: "Independent Short-form Red-Team", remit: "Challenge weak hooks, false confidence, repetitive scenes and repairs that improve scores without improving \
the viewer experience.", authority: "challenge" },
    ],
  },
  "zernio-social-copy": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Social Editorial Chair", remit: "Chair the meeting, reconcile copy, platform, visual and brand findings, and make the final schedule-or-quarantine \
decision.", authority: "final-decision" },
      { seat: 2, role: "Jonathan Harris Voice Editor", remit: "Protect Jonathan's practical, sceptical, direct voice and reject generic AI commentary, motivational filler and \
corporate phrasing.", authority: "hard-gate" },
      ...
      { seat: 5, role: "Engagement and Conversation Reviewer", remit: "Check that any reader prompt invites thoughtful response and never relies on likes, tags, one-word \
answers or manufactured engagement.", authority: "advisory" },
      ...
      { seat: 7, role: "Platform Fit Reviewer", remit: "Check readability, length and structure for the targeted Facebook and Instagram destinations without forcing both into \
lowest-common-denominator copy.", authority: "hard-gate" },
      { seat: 8, role: "Dynamic Hashtag Strategist", remit: "Keep hashtags relevant, sparse and topic-specific, avoiding broad filler tags that add noise rather than discovery \
value.", authority: "advisory" },
      { seat: 9, role: "Visual-Copy Alignment Reviewer", remit: "Verify the image concept and written post communicate the same specific idea and do not create a misleading or \
generic visual story.", authority: "hard-gate" },
      { seat: 10, role: "Cross-Platform Coherence Reviewer", remit: "Ensure account variants preserve the same factual meaning and editorial point while avoiding byte-\
identical cross-posting.", authority: "advisory" },
      ...
      { seat: 14, role: "Scheduling Readiness Reviewer", remit: "Verify final copy, links, image attachment, target accounts, publish time and duplicate protection are ready \
for scheduling.", authority: "hard-gate" },
      { seat: 15, role: "Independent Social Red-Team", remit: "Challenge blandness, overlong padding, weak evidence and repairs that technically pass but do not improve reader \
value.", authority: "challenge" },
    ],
  },
  "zernio-mini-series": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Mini-Series Editorial Chair", remit: "Chair the meeting, protect the series-level editorial arc and make the final approve, repair or quarantine \
decision for each part.", authority: "final-decision" },
      { seat: 2, role: "Source Integrity Reviewer", remit: "Verify every post stays inside the approved evidence set and does not invent facts, dates, legal conclusions or \
certainty.", authority: "hard-gate" },
      { seat: 3, role: "Jonathan Harris Voice Editor", remit: "Protect the same practical, sceptical Jonathan voice across all parts without making each post sound \
mechanically identical.", authority: "hard-gate" },
      { seat: 4, role: "Topical Relevance Editor", remit: "Ensure every part remains tightly tied to the approved timely topic and does not wander into generic AI commentary.",
         authority: "hard-gate" },
      ...
      { seat: 6, role: "Series Continuity Reviewer", remit: "Check that parts progress coherently, avoid repetition and remain useful individually while forming one editorial \
journey.", authority: "hard-gate" },
      ...
      { seat: 10, role: "Publishing Readiness Reviewer", remit: "Confirm approved hashtags, image prompt, source URLs, schedule and required fields are complete before \
scheduling each part.", authority: "hard-gate" },
      { seat: 11, role: "Independent Series Red-Team", remit: "Challenge repetitive angles, weak evidence and a forced series where the topic no longer supports another useful \
post.", authority: "challenge" },
    ],
  },
  "zernio-ebook-conversion": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "eBook Conversion Chair", remit: "Chair the meeting, reconcile editorial and commercial findings, enforce link integrity, and make the final schedule-or-\
quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "eBook Editorial Director", remit: "Ensure the post communicates a real idea from the supplied book metadata rather than reading like catalogue copy or \
an advert.", authority: "hard-gate" },
      { seat: 3, role: "Online Digital Marketing Expert", remit: "Judge positioning, audience relevance and commercial clarity without introducing fake urgency, unsupported \
scarcity or promotional sludge.", authority: "advisory" },
      ...
      { seat: 6, role: "Source and Claims Reviewer", remit: "Verify every claim is supported by supplied book metadata and block invented reviews, rankings, reader reactions, \
credentials or outcomes.", authority: "hard-gate" },
      ...
      { seat: 8, role: "Commercial Relevance Reviewer", remit: "Check that the book is promoted to a relevant audience and the copy makes the commercial connection without \
hard selling.", authority: "advisory" },
      ...
      { seat: 10, role: "Social Proof Integrity Reviewer", remit: "Block fabricated endorsements, popularity claims, rankings or social proof not present in the supplied \
evidence.", authority: "hard-gate" },
      ...
      { seat: 13, role: "Grammar, Spelling and Punctuation Expert", remit:
         "Correct language mechanics, sentence construction and punctuation without flattening Jonathan's voice.", authority: "hard-gate" },
      { seat: 14, role: "CTA and Link Integrity Reviewer", remit: "Confirm the exact book URL survives every repair and the CTA describes the real destination without \
misleading wording.", authority: "hard-gate" },
      { seat: 15, role: "Independent Conversion Red-Team", remit: "Challenge empty persuasion, unsupported claims and any repair that improves sales tone by weakening \
credibility.", authority: "challenge" },
    ],
  },
  "quiz-logic": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Quiz Editorial Chair", remit: "Chair the review and make the final publish-or-quarantine decision only when question, options and answer validate as \
one coherent unit.", authority: "final-decision" },
      ...
      { seat: 5, role: "Audience Level Reviewer", remit: "Keep difficulty appropriate for an intelligent general AI audience without triviality or unexplained specialist \
jargon.", authority: "advisory" },
  ...
  "podcast-on-brand": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Podcast Editorial Chair", remit: "Chair the meeting, reconcile source, narrative, spoken-performance and metadata findings, and make the final publish-\
or-quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "Source Integrity Reviewer", remit: "Verify factual claims, quotations, dates and attribution against supplied sources and block unsupported narrative \
embellishment.", authority: "hard-gate" },
      ...
      { seat: 4, role: "Opening Hook Reviewer", remit: "Judge whether the first minute establishes a concrete reason to listen and avoids throat-clearing or generic \
introductions.", authority: "hard-gate" },
      ...
      { seat: 6, role: "Narrative Arc Reviewer", remit: "Ensure the episode progresses through a coherent argument or story rather than a sequence of isolated news summaries.",
         authority: "hard-gate" },
      ...
      { seat: 9, role: "TTS Performance Reviewer", remit: "Check punctuation, sentence length, acronyms, pronunciation hazards and rhythm for reliable synthetic voice \
delivery.", authority: "hard-gate" },
      { seat: 10, role: "Ending and Takeaway Reviewer", remit: "Require a clear landing point, useful takeaway and proportionate close rather than an abrupt stop or generic \
sign-off.", authority: "hard-gate" },
      ...
      { seat: 19, role: "Long-form Editorial Director", remit: "Judge the episode as a complete professional programme for depth, coherence, usefulness and editorial \
authority.", authority: "hard-gate" },
      { seat: 20, role: "Independent Podcast Red-Team", remit: "Challenge weak sourcing, circular argument, inflated claims and passages that pass locally but weaken the whole \
episode.", authority: "challenge" },
    ],
  },
  "newsletter-editorial": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "AI Edge Editorial Chair", remit: "Chair the meeting, reconcile source, voice, structure, audience and promotion findings, and make the final send-or-\
quarantine decision.", authority: "final-decision" },
      { seat: 2, role: "Source Integrity and Fact-Checking Reviewer", remit:
         "Verify every story, title, summary, link and editorial claim against the supplied source evidence and block mismatches.", authority: "hard-gate" },
      ...
      { seat: 4, role: "Newsletter Structure and Scanability Editor", remit:
         "Keep the issue navigable in roughly five minutes with clear hierarchy, concise sections and useful visual rhythm.", authority: "hard-gate" },
      { seat: 5, role: "Audience Value and Retention Reviewer", remit: "Check every major section earns its place and gives readers a reason to continue or return next issue.",
         authority: "hard-gate" },
      { seat: 6, role: "Subject Line and Open-Rate Reviewer", remit: "Judge subject and preview text for clarity, specificity and curiosity without opaque wording or \
clickbait.", authority: "advisory" },
      { seat: 7, role: "Reality Check Scepticism Reviewer", remit: "Verify the Reality Check challenges a real claim with correctly paired evidence and does not manufacture a \
straw man.", authority: "hard-gate" },
      ...
      { seat: 9, role: "Book and Podcast Promotion Balance Reviewer", remit:
         "Keep Tuesday book and Thursday podcast promotion useful, proportionate and clearly secondary to editorial value.", authority: "hard-gate" },
      ...
      { seat: 11, role: "Cross-Channel Duplication Reviewer", remit: "Detect copy-paste repetition from blog, podcast and social channels while allowing purposeful thematic \
reinforcement.", authority: "advisory" },
      ...
      { seat: 13, role: "Publishing Readiness Reviewer", remit: "Verify links, section pairing, promotional timing, image readiness and delivery fields before the issue may be \
stored for sending.", authority: "hard-gate" },
      { seat: 14, role: "Independent Newsletter Red-Team", remit: "Challenge story selection, unsupported rhetoric, source mismatches and groupthink before the chair approves \
the issue.", authority: "challenge" },
    ],
  },
  "social-performance": {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Social Performance Chair", remit: "Chair the review, reconcile platform evidence and make the final bounded recommendation set without inventing \
missing metrics.", authority: "final-decision" },
      { seat: 2, role: "Facebook Performance Reviewer", remit: "Interpret Facebook-specific reach, engagement and click evidence only where those metrics are actually \
supplied.", authority: "advisory" },
      { seat: 3, role: "Instagram Performance Reviewer", remit: "Interpret Instagram-specific reach, saves, shares and engagement evidence without extrapolating from other \
platforms.", authority: "advisory" },
      ...
      { seat: 6, role: "Thumbnail Evidence Reviewer", remit: "Compare packaging evidence to measured performance and avoid declaring thumbnail causes without supporting data.",
         authority: "advisory" },
      ...
      { seat: 8, role: "Independent Performance Red-Team", remit: "Challenge causal claims, cherry-picked examples and recommendations not supported by measured platform \
evidence.", authority: "challenge" },
    ],
  },
  housekeeping: {
    ...
    defaultEnabled: true,
    members: [
      { seat: 1, role: "Housekeeping Completion Chair", remit: "Chair the cleanup review and authorise deletion only when every candidate is proven temporary or duplicate and \
no evidence is endangered.", authority: "final-decision" },
