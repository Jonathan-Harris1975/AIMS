...
| `BLOG_SOCIAL_PREFIX` | Yes | services/blog/routes/social.js:41<br>services/blog/social/buildDailySocialBlogPost.js:571<br>services/blog/social/publishSocialBlogRssFeed.js:69 |
...
| `BLOG_SOCIAL_RSS_OBJECT_KEY` | Yes | services/blog/social/buildDailySocialBlogPost.js:778<br>services/blog/social/buildDailySocialBlogPost.js:913<br>services/blog/social/buildDailySocialBlogPost.js:1087<br>services/blog/social/publishSocialBlogRssFeed.js:91 |
...
| `BLOTATO_DEFAULT_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1111 |
| `BLOTATO_DEFAULT_FOLLOW_CTA` | Yes | services/blotato/utils/newsShortsService.js:230 |
| `BLOTATO_FACEBOOK_MEDIA_TYPE` | Yes | services/blotato/utils/autoPublishService.js:932 |
| `BLOTATO_FACEBOOK_PAGE_ID` | Yes | services/blotato/utils/autoPublishService.js:786<br>services/blotato/utils/autoPublishService.js:929 |
| `BLOTATO_FACEBOOK_SUBACCOUNT_ID` | No | services/blotato/utils/autoPublishService.js:786<br>services/blotato/utils/autoPublishService.js:929 |
...
| `BLOTATO_IMAGE_TO_VIDEO_MODEL` | Yes | services/blotato/utils/autoPublishService.js:469 |
| `BLOTATO_INLINE_PUBLISH_JOBS` | No | services/blotato/utils/autoPublishService.js:2168 |
| `BLOTATO_INSTAGRAM_SHARE_TO_FEED` | Yes | services/blotato/utils/autoPublishService.js:898 |
| `BLOTATO_KEEPALIVE_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1358 |
| `BLOTATO_LOW_COST_IMAGE_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:468<br>services/blotato/utils/newsShortsService.js:30 |
| `BLOTATO_LOW_COST_VIDEO_MODEL_LABEL` | Yes | services/blotato/utils/autoPublishService.js:469<br>services/blotato/utils/newsShortsService.js:31 |
| `BLOTATO_NEWS_AUDIENCE` | No | services/blotato/utils/autoPublishService.js:1399 |
| `BLOTATO_NEWS_CTA` | Yes | services/blotato/utils/autoPublishService.js:1404 |
| `BLOTATO_NEWS_DURATION_SECONDS` | Yes | services/blotato/utils/autoPublishService.js:1397 |
...
| `BLOTATO_NEWS_TEMPLATE_ID` | Yes | services/blotato/utils/autoPublishService.js:1124<br>services/blotato/utils/autoPublishService.js:1125 |
| `BLOTATO_NEWS_TEMPLATE_SEARCH` | Yes | services/blotato/utils/autoPublishService.js:345<br>services/blotato/utils/autoPublishService.js:1129 |
| `BLOTATO_NEWS_THEME` | No | services/blotato/utils/autoPublishService.js:1395 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_ACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:746 |
| `BLOTATO_PREFLIGHT_REQUIRE_LISTED_SUBACCOUNTS` | Yes | services/blotato/utils/autoPublishService.js:794<br>services/blotato/utils/autoPublishService.js:822 |
| `BLOTATO_PUBLISH_SEQUENTIAL` | Yes | services/blotato/utils/autoPublishService.js:1089 |
| `BLOTATO_PUBLISH_STAGGER_MS` | Yes | services/blotato/utils/autoPublishService.js:1088 |
...
| `BLOTATO_RENDERED_QA_BLOCK_SOFT_FAILURES` | Yes | services/blotato/utils/autoPublishService.js:1657 |
...
| `BLOTATO_REQUIRE_ALL_CHANNELS` | Yes | services/blotato/utils/autoPublishService.js:1806 |
| `BLOTATO_REQUIRE_SCHEDULE_CONFIRMATION` | Yes | services/blotato/utils/autoPublishService.js:1010 |
...
| `BLOTATO_RSS_PICK_MODE` | Yes | services/blotato/utils/autoPublishService.js:1130<br>services/blotato/utils/rssArticlePicker.js:67<br>services/blotato/utils/rssArticleSource.js:220 |
...
| `BLOTATO_SCHEDULE_RECOVERY_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:1323 |
| `BLOTATO_SCRIPT_TIMEOUT_MS` | Yes | services/blotato/utils/newsShortsService.js:1313 |
| `BLOTATO_STEP0_PREFLIGHT_ENABLED` | Yes | services/blotato/utils/autoPublishService.js:838 |
| `BLOTATO_TEMPLATE_AUTO_DISCOVERY` | Yes | services/blotato/utils/autoPublishService.js:343<br>services/blotato/utils/autoPublishService.js:1128 |
| `BLOTATO_TEMPLATE_ID_MODE` | Yes | services/blotato/utils/autoPublishService.js:164<br>services/blotato/utils/autoPublishService.js:1126 |
| `BLOTATO_TEMPLATE_SEARCH` | No | services/blotato/utils/autoPublishService.js:345<br>services/blotato/utils/autoPublishService.js:1129 |
| `BLOTATO_TEMPLATE_VERIFY` | Yes | services/blotato/utils/autoPublishService.js:341<br>services/blotato/utils/autoPublishService.js:1127 |
| `BLOTATO_TEXT_TO_IMAGE_MODEL` | Yes | services/blotato/utils/autoPublishService.js:468<br>services/blotato/utils/newsShortsService.js:46 |
...
| `BLOTATO_TIKTOK_DISABLED_COMMENTS` | Yes | services/blotato/utils/autoPublishService.js:919 |
| `BLOTATO_TIKTOK_DISABLED_DUET` | Yes | services/blotato/utils/autoPublishService.js:920 |
| `BLOTATO_TIKTOK_DISABLED_STITCH` | Yes | services/blotato/utils/autoPublishService.js:921 |
| `BLOTATO_TIKTOK_IS_AI_GENERATED` | Yes | services/blotato/utils/autoPublishService.js:924 |
| `BLOTATO_TIKTOK_IS_BRANDED_CONTENT` | Yes | services/blotato/utils/autoPublishService.js:922 |
| `BLOTATO_TIKTOK_IS_YOUR_BRAND` | Yes | services/blotato/utils/autoPublishService.js:923 |
| `BLOTATO_TIKTOK_PRIVACY_LEVEL` | Yes | services/blotato/utils/autoPublishService.js:918 |
| `BLOTATO_TIMEOUT_MS` | Yes | services/blotato/utils/blotatoClient.js:151 |
| `BLOTATO_USE_BRAND_KIT` | Yes | services/blotato/utils/autoPublishService.js:583 |
| `BLOTATO_USE_MANUAL_TEMPLATE_INPUTS` | Yes | services/blotato/utils/autoPublishService.js:576 |
...
| `BLOTATO_YOUTUBE_NOTIFY_SUBSCRIBERS` | Yes | services/blotato/utils/autoPublishService.js:908 |
| `BLOTATO_YOUTUBE_PRIVACY_STATUS` | Yes | services/blotato/utils/autoPublishService.js:907 |
...
| `COMMS_HUB_CONTENT_AUTOMATION_BLOTATO_VIDEO_BRIEF_LIMIT` | Yes | services/blotato/utils/autoPublishService.js:2065 |
| `COMMS_HUB_CONTENT_AUTOMATION_BRIEF_LEASE_MS` | Yes | services/comms-hub/contentAutomationQueueCore.js:325 |
| `COMMS_HUB_CONTENT_AUTOMATION_BRIEF_LIMIT` | Yes | services/blog/social/buildDailySocialBlogPost.js:583<br>services/blog/weekly/buildWeeklyBlogPost.js:499<br>services/podcast/runPodcastPipeline.js:140 |
...
| `COMMS_HUB_CONTENT_AUTOMATION_ZERNIO_MINI_SERIES_BRIEF_LIMIT` | Yes | services/zernio/utils/socialScheduler.js:2232 |
...
| `COMMS_HUB_MAX_WEBHOOK_BYTES` | Yes | server.js:247<br>server.js:337 |
...
| `CORS_ORIGINS` | Yes | server.js:222 |
...
| `JSON_BODY_LIMIT` | Yes | server.js:369 |
...
| `SHUTDOWN_TIMEOUT_MS` | Yes | server.js:573 |
...
| `ZERNIO_ALLOW_CURATED_ARTWORK_FALLBACK` | Yes | services/zernio/utils/socialScheduler.js:1763<br>services/zernio/utils/socialScheduler.js:2629<br>services/zernio/utils/socialScheduler.js:3088 |
...
| `ZERNIO_MINI_SERIES_RETRY_BASE_MS` | Yes | services/zernio/utils/socialScheduler.js:2687 |
