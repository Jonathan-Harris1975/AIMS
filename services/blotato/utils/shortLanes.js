export const BLOTATO_SHORT_LANES = Object.freeze([
  {
    ...
    visualSignature: "Human-centred newsroom composition with a believable adult analyst or viewer reacting in the first frame, plus unlabelled geometric panels, abstract \
timeline motion and interface glows without UI copy. Slow push-in or horizontal panel reveal. No text, pseudo-text, numbers, logos or typographic marks on generated images.",
  ...
  },
  {
    ...
    visualSignature: "Human-centred split-panel comparisons with an adult user, analyst or operator visibly choosing between tools, plus unlabelled interface abstractions and \
purely visual benchmark contrasts on dark backgrounds. Horizontal panel reveal. No text, pseudo-text, numbers, logos or typographic marks on generated images.",
  ...
  },
  {
    ...
    visualSignature: "Workspace environments with believable adult workers, hands on devices, body language and human checkpoints, supported by object-based workflow paths, \
desk abstractions and text-free process geometry. Slow push-in. No text, pseudo-text, numbers, logos or typographic marks on generated images.",
  ...
  },
  {
    ...
    visualSignature: "Claim-vs-reality contrast layouts using an expressive adult reaction or over-shoulder human review moment, opposing objects, crossed visual motifs and \
signal-vs-noise geometry on dark backgrounds. Hard cut between two contrasting visuals. No documents, text, pseudo-text, numbers, logos or typographic marks on generated images.",
  ...
  },
  {
    ...
    visualSignature: "Sequential human-workflow process scenes with adult hands, posture and practical decision moments, supported by unlabelled checklist symbols and clean \
workflow geometry. Horizontal reveal, one visual stage per step. No text, pseudo-text, numbers, logos or typographic marks on generated images.",
